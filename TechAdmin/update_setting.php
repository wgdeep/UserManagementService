...
if (isset($_REQUEST['edit_id']) && $_REQUEST['edit_id'] != '') {
    ...
    $settinginfo = editData($con, 'setting', $edit_id);
}
?>
                                    ...
                                    <div class="card">
                                        <div class="card-body add-post">
                                            <form class="row needs-validation" method="post" action="" novalidate="" enctype="multipart/form-data">
                                                <input type="hidden" name="id" value="<?php echo $settinginfo['id'] ?>">
                                                <div class="mb-3 row">
                                                    <label for="1" class="col-sm-3">Address 1</label>
                                                    <div class="col-sm-9">
                                                        <div class="form-floating">
                                                            <textarea class="form-control" name="address1" id="1" style="height: 100px"> <?php echo $settinginfo['address1'] ?> </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="form-floating">
                                                            <textarea class="form-control" name="address2" id="2" style="height: 100px"> <?php echo $settinginfo['address2'] ?> </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="form-floating">
                                                            <textarea class="form-control" name="address3" id="3" style="height: 100px"> <?php echo $settinginfo['address3'] ?> </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="phone1" class="form-control m-input digits" type="tel" name="phone1"
                                                            value="<?php echo $settinginfo['phone1'] ?>" placeholder="91-(999)-999-999">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="phone2" class="col-sm-3">Phone2</label>
                                                    <div class="col-sm-9">
                                                        <input id="phone2" class="form-control m-input digits" type="tel" name="phone2"
                                                            value="<?php echo $settinginfo['phone2'] ?>" placeholder="91-(999)-999-999">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="phone3" class="col-sm-3">Phone3</label>
                                                    <div class="col-sm-9">
                                                        <input id="phone3" class="form-control m-input digits" type="tel" name="phone3"
                                                            value="<?php echo $settinginfo['phone3'] ?>" placeholder="91-(999)-999-999">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for='email1' class="col-sm-3">Email1</label>
                                                    <div class="col-sm-9">
                                                        <input id="email1" class="form-control m-input digits" type="tel" name="email1"
                                                            value="<?php echo $settinginfo['email1'] ?>" placeholder="test1@gmail.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for='email2' class="col-sm-3">Email2</label>
                                                    <div class="col-sm-9">
                                                        <input id="email2" class="form-control m-input digits" type="tel" name="email2"
                                                            value="<?php echo $settinginfo['email2'] ?>" placeholder="test2@gmail.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for='email3' class="col-sm-3">Email3</label>
                                                    <div class="col-sm-9">
                                                        <input id="email3" class="form-control m-input digits" type="tel" name="email3"
                                                            value="<?php echo $settinginfo['email3'] ?>" placeholder="test3@gmail.com">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="Facebook" class="form-control" name="fburl" type="url"
                                                            value="<?php echo $settinginfo['fburl'] ?>" placeholder="https://facebook.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="Instagram" class="col-sm-3">Instagram URL</label>
                                                    <div class="col-sm-9">
                                                        <input id="Instagram" class="form-control" name="igurl" type="url"
                                                            value="<?php echo $settinginfo['igurl'] ?>" placeholder="https://instagram.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="Youtube" class="col-sm-3">Youtube URL</label>
                                                    <div class="col-sm-9">
                                                        <input id="Youtube" class="form-control" name="yturl" type="url"
                                                            value="<?php echo $settinginfo['yturl'] ?>" placeholder="https://youtube.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="linkedin" class="col-sm-3">Linkedin URL</label>
                                                    <div class="col-sm-9">
                                                        <input id="linkedin" class="form-control" name="liurl" type="url"
                                                            value="<?php echo $settinginfo['liurl'] ?>" placeholder="https://linkedin.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="Pinterest" class="col-sm-3" style="margin-left: 10px;">Pinterest URL</label>
                                                    <div class="col-sm-9">
                                                        <input id="Pinterest" class="form-control" name="pturl" type="url"
                                                            value="<?php echo $settinginfo['pturl'] ?>" placeholder="https://pinterest.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="Pinterest" class="col-sm-3" style="margin-left: 10px;">Logo</label>
                                                    <div class="col-sm-9" style="padding-top: 15px;padding-left: 0px;left: 15px;"">
                                                    <div class=" input-group">
                                                        <div>
                                                            <div class="input-group-prepend" style="margin-top: 10px;margin-right: 15px;"><span class="input-group-text col-sm-">Logo</span></div>
                                                        </div>
                                                        <div class="col-sm-8">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="Pinterest" class="col-sm-3" style="margin-left: 10px;">Favicon</label>
                                            <div class="col-sm-9" style="padding-top: 15px;padding-left: 0px;left: 15px;"">
                                                    <div class=" input-group">
                                                <div>
                                                    <div class="input-group-prepend" style="margin-top: 10px;margin-right: 15px;"><span class="input-group-text col-sm-">Favicon</span></div>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="card form-control mb-2" style="display: flex; flex-direction:row;margin-left: calc(var(--bs-border-width) * 3);padding-right: 4.75rem;border-right-width: 1px;margin-top: 5px;margin-bottom: 0px; width: 82%;">
                                                        <?php
                                            ...
                                            <input type="hidden" name="existing_faviconLogo" value="<?php echo htmlspecialchars($favicon); ?>">

                                            <input type="file" name="attached_faviconLogo" id="logo" class="form-control" multiple>
                                        </div>
                                    </div>

                                    <div class="btn-showcase text-end">
                                        <button class="btn btn-primary" name="submit" value="Edit Setting" type="submit">Update</button>
                                    </div>
                                    </form>
