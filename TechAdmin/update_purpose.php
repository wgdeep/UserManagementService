...
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Add Purpose") {
    addPurpose($con, $_REQUEST, $error);
}


if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Edit Purpose") {
    updatePurpose($con, $_REQUEST, $error);
}


if (isset($_REQUEST['edit_id']) && $_REQUEST['edit_id'] != '') {
    $edit_id = $_REQUEST['edit_id'];
    $purposeinfo = editData($con, 'purpose', $edit_id);
}
                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Update Purpose</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="card">
                                        <div class="card-body add-post">
                                            <form class="row needs-validation" action="?id=<?php echo $purposeinfo['id']; ?>" method="POST" enctype="multipart/form-data">

                                                <div class="col-sm-6">
                                                    <label for="Title">Title:</label>
                                                    <input class="form-control" id="Title" type="text"
                                                         name="title" value="<?php echo $purposeinfo['title'] ?>">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="Sub">Sub Title:</label>
                                                    <input class="form-control" id="Sub" type="text"
                                                         name="sub_title" value="<?php echo $purposeinfo['sub_title'] ?>">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
        
                                                <div class="col-sm-12" style="padding-top: 15px;padding-left: 0px;left: 15px;"">
                                                    ...
                                                    <div class="card form-control" style="display: flex; flex-direction:row;margin-left: calc(var(--bs-border-width) * 17);padding-right: 4.75rem;border-right-width: 1px;">
                                                        <?php
                                                        $Image = $purposeinfo['image'];
                                                        if (!empty($Image)) {
                                                            $imagePath = "./data/purpose/image/" . htmlspecialchars(trim($Image));
                                            ...
                                            <div class="email-wrapper">
                                                <div class="theme-form">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="text-box" name="description" cols="10" rows="2">  <?php echo $purposeinfo['description'] ?> </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="btn-showcase text-end">
                                            <button class="btn btn-primary" name="submit" value="Edit Purpose" type="submit">Update</button>
                                        </div>
