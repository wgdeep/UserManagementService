                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Add Seo</h3>
                            </div>
                                                    ...
                                                    <div class="email-wrapper">
                                                        <div class="theme-form">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea id="text-box" name="meta_description" cols="10" rows="2"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="btn-showcase text-end">
                                                    <button class="btn btn-primary" name="submit" value="Add Seo" type="submit">Add</button>
                                                </div>
