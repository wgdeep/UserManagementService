        ...
        <nav class="sidebar-main">
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                    ...
                    </li><li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                            <svg class="stroke-icon">
                                <use href="assets/svg/icon-sprite.svg#home"></use>
                            </svg>
                            <svg class="fill-icon">
                        ...
                        <ul class="sidebar-submenu custom-scrollbar">
                            ...
                            </li><li class="main-submenu"><a class="d-flex sidebar-menu" href="javascript:void(0)">
                                    <svg class="stroke-icon">
                                        <use href="assets/svg/icon-sprite.svg#home"></use>
                                    </svg>
                                    <svg class="fill-icon">
