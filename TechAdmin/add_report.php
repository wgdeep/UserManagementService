...
$error = '';
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Add Report") {
    addReport($con, $_REQUEST, $error);
}
?>
                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Add Report</h3>
                            </div>
                                            ...
                                            <form class="row needs-validation" method="post" action="" novalidate="" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="form-control" id="URL" type="text"
                                                        placeholder="Post Pdf URL" name="pdf">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="col-sm-12">
                                                ...
                                                <div class="btn-showcase text-end">
                                                    <button type="submit" class="btn btn-primary" name="submit" value="Add Report">Add</button>
                                                </div>
