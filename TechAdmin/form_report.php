...
if (isset($_REQUEST['del_id']) && $_REQUEST['del_id'] != '') {
    ...
    deleteDataWithImg($con, 'form_report', $_REQUEST['del_id']);

    echo "<script>window.location = '" . $wwwroot . "/form_report.php?act=del';</script>";
                ...
                <div class="page-title" style="margin:0px;">
                    <div class="row">
                        <div class="col-sm-6 ps-0">
                            <h3><b> Form Report </b><?php if (isset($_REQUEST['act']) && $_REQUEST['act'] == 'del') {
                        ...
                        <div class="col-sm-6 ps-0">
                            <div class="btn-showcase text-end">
                                <a class="btn btn-primary" style="color: white;margin-bottom: 0px;margin-right: 0px;"" href=" add_form_report.php">Add Form Report</a>
                            </div>
                        </div>
                                            ...
                                            $(document).ready(function() {
                                                ...
                                                $('#tableshowid').DataTable({
                                                    ...
                                                    "ajax": {
                                                        ...
                                                        url: "ajaxdataload/allform_report.php",
