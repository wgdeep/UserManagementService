...
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Edit Form Report") {
    updateFormReport($con, $_REQUEST, $error);
}


if (isset($_REQUEST['edit_id']) && $_REQUEST['edit_id'] != '') {
    $edit_id = $_REQUEST['edit_id'];
    $formReportInfo = editData($con, 'form_report', $edit_id);
}
                                    ...
                                    <div class="card">
                                        <div class="card-body add-post">
                                            <form class="row needs-validation" action="?id=<?php echo $formReportInfo['id']; ?>" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-6">
                                                    <label for="email">Post1:</label>
                                                    <input class="form-control" id="email" type="text"
                                                        placeholder="Post email" name="email" value="<?php echo $formReportInfo['email'] ?>">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="phone">Post2:</label>
                                                    <input class="form-control" id="phone" type="text"
                                                        placeholder="Post phone" name="phone" value="<?php echo $formReportInfo['phone'] ?>">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="email-wrapper">
                                                        <div class="theme-form">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea id="text-box" name="message" cols="10" rows="2">  <?php echo $formReportInfo['message'] ?> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="btn-showcase text-end">
                                                    <button class="btn btn-primary" name="submit" value="Edit Form Report" type="submit">Update</button>
                                                </div>
