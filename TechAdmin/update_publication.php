...
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Edit Publication") {
    updatepublication($con, $_REQUEST, $error);
}


if (isset($_REQUEST['edit_id']) && $_REQUEST['edit_id'] != '') {
    $edit_id = $_REQUEST['edit_id'];
    $publicationinfo = editData($con, 'publication', $edit_id);
}
                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Update Publication</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="card">
                                            ...
                                            <form class="row needs-validation" action="?id=<?php echo $publicationinfo['id']; ?>" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class=" input-group mb-3">
                                                        <div class="col-sm-12">
                                                            <div class="input-group-prepend col-sm-3" style="padding-left: -0.25rem;border-left-style: solid;margin-left: 2px;border-left-width: 0px;"><span class="input-group-text">Banner Image</span></div>
                                                        </div>
                                                        <div class="card form-control" style="display: flex; flex-direction:row;margin-left: calc(var(--bs-border-width) * 3);padding-right: 4.75rem;border-right-width: 1px;margin-bottom: 0px;margin-top: 5px;">
                                                            <?php
                                                            $bannerImage = $publicationinfo['banner_image'];
                                                            if (!empty($bannerImage)) {
                                                                $bannerPath = "./data/publication/banner/" . htmlspecialchars(trim($bannerImage));
                                                                echo "<a class='socialContainerBanner'><img id='bannerImg' width='150' class='socialSvg instagramSvg' src='$bannerPath' alt='banner_image'></a>";
                                                            } else {
                                                ...
                                                <input class="" type="hidden" name="existing_banner" value="<?php echo htmlspecialchars($bannerImage); ?>">


                                                <div class="col-sm-6" style="padding-left: 0px;padding-bottom: 15px;">
                                                    <input style="padding-left: 10px;padding-top: 7px;border-left-width: 0px;margin-left: 4px;" type="file" name="attached_banner" id="banner" class="form-control" >
                                                </div>
                                        </div>
                                            ...
                                            <div class="email-wrapper">
                                                <div class="theme-form">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="text-box" name="description" cols="10" rows="2">  <?php echo $publicationinfo['description'] ?> </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="btn-showcase text-end">
                                            <button class="btn btn-primary" name="submit" value="Edit Publication" type="submit">Update</button>
                                        </div>
