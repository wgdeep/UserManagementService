...
$error = '';
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Add Role") {
    addRole($con, $_REQUEST, $error);
}
?>
                                            ...
                                            <form class="row needs-validation" method="post" action="" novalidate="" enctype="multipart/form-data">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="form-control" id="Role" type="text"
                                                        placeholder="Enter Role" name="role_name" required="">
                                                ...
                                                <div class="btn-showcase text-end">
                                                    <button class="btn btn-primary" name="submit" value="Add Role" type="submit">Add</button>
                                                </div>
