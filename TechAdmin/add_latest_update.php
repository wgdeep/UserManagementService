...
$error = '';
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Add Latest Update") {
    addLatestUpdate($con, $_REQUEST, $error);
}
?>
                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Add Latest Update</h3>
                            </div>
                                        ...
                                        <div class="card-body add-post">
                                            <form class="row needs-validation" method="post" action="" novalidate="" enctype="multipart/form-data">
                                                ...
                                                <div class="btn-showcase text-end">
                                                    <button class="btn btn-primary" style="margin-bottom: 1px;margin-right: 6px;margin-top: 9px;" name="submit" value="Add Latest Update" type="submit">Add</button>
                                                </div>
