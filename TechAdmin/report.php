                ...
                <div class="page-title" style="margin:0px;">
                    <div class="row">
                        <div class="col-sm-6 ps-0">
                            <h3><b> Report </b><?php if (isset($_REQUEST['act']) && $_REQUEST['act'] == 'del') {
                        ...
                        <div class="col-sm-6 ps-0">
                            <div class="btn-showcase text-end">
                                <a class="btn btn-primary" style="color: white;margin-bottom: 0px;margin-right: 0px;"" href=" add_report.php">Add Report</a>
                            </div>
                        </div>
                                            ...
                                            $(document).ready(function() {
                                                ...
                                                $('#tableshowid').DataTable({
                                                    ...
                                                    "ajax": {
                                                        ...
                                                        url: "ajaxdataload/allreport.php",
