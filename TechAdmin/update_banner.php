...
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Edit Banner") {
    updateBanner($con, $_REQUEST, $error);
}


if (isset($_REQUEST['edit_id']) && $_REQUEST['edit_id'] != '') {
    $edit_id = $_REQUEST['edit_id'];
    $bannerinfo = editData($con, 'banner', $edit_id);
}
                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Update Banner</h3>
                            </div>
