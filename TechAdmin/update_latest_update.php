...
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Edit Latest Update") {
    updateLatestUpdate($con, $_REQUEST, $error);
}


if (isset($_REQUEST['edit_id']) && $_REQUEST['edit_id'] != '') {
    $edit_id = $_REQUEST['edit_id'];
    $latestupdateinfo = editData($con, 'latest_update', $edit_id);
}
                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Update Latest Update</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="card">
                                            ...
                                            <form class="row needs-validation" action="?id=<?php echo $latestupdateinfo['id']; ?>" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12" style="padding-top: 15px;padding-left: 0px;left: 15px;"">
                                                    ...
                                                    <div class="card form-control" style="display: flex; flex-direction:row;margin-left: calc(var(--bs-border-width) * 17);padding-right: 4.75rem;border-right-width: 1px;">
                                                        <?php
                                                        $Image = $latestupdateinfo['image'];
                                                        if (!empty($Image)) {
                                                            $imagePath = "./data/latest_update/image/" . htmlspecialchars(trim($Image));
                                        ...
                                        <div class="btn-showcase text-end">
                                            <button class="btn btn-primary" name="submit" value="Edit Latest Update" type="submit">Update</button>
                                        </div>
