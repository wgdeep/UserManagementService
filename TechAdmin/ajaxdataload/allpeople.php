...
while ($row = mysqli_fetch_assoc($empRecords)) {
    ...
    $data[] = array(
        ...
        "edate" => $row['edate'],
        "etime" => $row['etime'],
        "action" => '<a title="Delete" href="people.php?del_id=' . $row['id'] . '"><i class="fa fa-trash-o"></i></a> <a title="Edit" href="update_people.php?edit_id=' . $row['id'] . '" style="margin-left: 10px;"><i class="fa fa-pencil"></i></a>',
    );
}
