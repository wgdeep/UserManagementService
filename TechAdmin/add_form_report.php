...
$error = '';
if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Add Form Report") {
    adminAddFormReport($con, $_REQUEST, $error);
}
?>
                    ...
                    <div class="page-title" style="margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-6 ps-0">
                                <h3 style="padding-bottom: 14px;margin-left: 15px;">Add Form Report</h3>
                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="email-wrapper">
                                                        <div class="theme-form">
                                                            <div class="mb-3">
                                                                <label>Message:</label>
                                                                <textarea id="text-box" name="message" cols="10" rows="2"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="btn-showcase text-end">
                                                    <button class="btn btn-primary" name="submit" value="Add Form Report" type="submit">Add</button>
                                                </div>
